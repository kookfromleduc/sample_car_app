        ...
        function carsCtrl($state, $scope, $stateParams, carsService) {
            ...
            vm.gridCars = {
                ...
                columnDefs: [
                    ...
                    { name:'make', field: 'make', enableHiding: false, enableFiltering: true, enableCellEdit: false, width: '15%'},
                    { name:'year', field: 'year', enableHiding: false, enableFiltering: true, enableCellEdit: false, width: '15%', cellClass: 'grid-align-right' },
                    { name:'color', field: 'color', enableHiding: false, width: '13%', enableCellEdit: false, cellClass: 'grid-align-right'},
                    { name:'passengerSeating', field: 'passenger_seating', enableHiding: false, width: '13%', enableCellEdit: false, cellClass: 'grid-align-right'},
            ...
            vm.editCar = function(row) {
                  $state.go('account.garage.car', {'rowEntity': row.entity});
            };
